...
const Footer = () => {
  return (
    <>
      <div className="flex justify-around bg-gray-800 text-white py-20 mt-10 ">
        ...
        <div className="flex flex-col  items-center">
          <h1 className="mb-4 text-2xl hover:scale-125 transition-all duration-500 cursor-pointer">Address</h1>
